...
(
	...
	[Name] VarChar (20) NULL, 		--작성자
	[Email] VarChar (30) NULL, 		--이메일
	[Title] VarChar (300) NULL, 		--설문제목
	[OptionCount] Int NULL, 			--설문문항수
	[OptionType] TinyInt NULL, 			--중복선택
	[CreatedDate] DateTime NULL, 		--설문등록일
	[Password] VarChar (20) NULL, 		--암호
	[Option1] VarChar(100) NULL, 		--문항1
	[Option2] VarChar(100) NULL, 		--문항2
	[Option3] VarChar(100) NULL, 		--문항3
	[Option4] VarChar(100) NULL, 		--문항4
	[Option5] VarChar(100) NULL, 		--문항5
	[Option6] VarChar(100) NULL, 		--문항6
	[Option7] VarChar(100) NULL, 		--문항7
	[Option8] VarChar(100) NULL, 		--문항8
	[Option9] VarChar(100) NULL, 		--문항9
	--
